...
prices_plot = plot_prices(
    prices;
    assets = ["NL_E_Balance", "UK_E_Balance", "DE_E_Balance",
    "DK_E_Balance", "NO_E_Balance", "OBZLL_E_Balance", 
...
flow_plot = plot_flow(
    ...
    year,
    rep_period;
    plots_args = (xlims = (0, 8760), xticks = 0:1000:8760),
)
