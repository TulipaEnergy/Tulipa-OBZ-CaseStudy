...
include(joinpath(@__DIR__, "../utils/preprocess-profiles.jl"))

@info "Pre-processing the user inputs"
include(joinpath(@__DIR__, "../utils/preprocess-user-inputs.jl"))
...
intra_storage_levels_file_name =
    joinpath(@__DIR__, "..", output_dir, "eu-case-intra-storage-levels.csv")
...
hydro_storage_levels_plot_name =
    joinpath(@__DIR__, "..", output_dir, "eu-case-hydro-storage-levels.png")
